        ...
        return (
            <div className="navbar_wrapper">
                ...
                <ul className="icons_list">
                    <li><a className='current_item'><HomeIcon className="icon"/><span className='menu_fonts'>Home</span></a></li>
                    <li><a><SearchIcon className="icon"/><span className='menu_fonts'> Search</span></a></li>
                    <li><a><LibraryIcon className="icon"/><span className='menu_fonts'>Your Library</span></a></li>
                </ul>
                ...
                <div className='app_install menu_fonts'>
                    <a className='app_install_link'>
                        ...
                        <span className="Type__TypeElement-goli3j-0 gnbLuy ellipsis-one-line">Install App</span>
                    </a>
                </div>
            </div>
        );
